...
par(mfrow=c(2,2))
plot(rawsub$datetime, rawsub$Global_active_power, ylab='Global Active Power', xlab='', type='l')
plot(rawsub$datetime, rawsub$Voltage, xlab='datetime', ylab='Voltage', type='l')
...
plot(rawsub$datetime, rawsub$Global_reactive_power, xlab='datetime', ylab='Global_reactive_power', type='l')
dev.off()
